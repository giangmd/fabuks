<template>
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-6">Exchange</div>
                <div class="col-6 text-right" v-if="isButtonDisabled">Next offer in <span class="time-left">{{ timeLeft }}</span></div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-9">
                    ...
                    <b-row>
                        <b-col>
                            <b-form-group id="input-group-3" label="From:" label-for="input-3">
                                <b-form-select
                                    id="input-3"
                                    v-model="form.from"
                        ...
                        <b-col>
                            <b-form-group id="input-group-4" label="To:" label-for="input-4">
                                <b-form-select
                                    id="input-4"
                                    v-model="form.to"
                    ...
                    <b-button type="submit" variant="primary" v-bind:disabled="isButtonDisabled">Place The Offer</b-button>
                </b-form>
                </div>
                <div class="col-3">
                    <h5>Wallet</h5>
                    <b-list-group>
                        <b-list-group-item v-for="cur in curs" 
                            v-bind:key="cur.key">{{ cur.key }} : {{ cur.value }}</b-list-group-item>
                    </b-list-group>
                </div>
            </div>
            
            <div class="mt-4">
                <b-card class="mt-3" border-variant="success" header="Trade History">
                    <b-table striped hover :items="trade_history" :fields="trade_fields"></b-table>
                </b-card>
            </div>
        </div>
    </div>
